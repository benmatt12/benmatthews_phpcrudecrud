...
<head>
<meta charset="utf-8">
<title>Employee Test Database</title>
</head>
...
$conn = new mysqli('localhost', 'phpuser', 'abc123', 'employees' );
...
//print rows of records found in the database if any
    while($row = $result->fetch_assoc()){
         echo "Employee: " . $row["first_name"]. " " . $row["last_name"]. ", Hired on: " . $row["hire_date"]. "<br>";
   }
 } else {
...
?>
<p>For more information on connecting PHP to MySQL, <a href="https://www.php.net/manual/en/book.mysqli.php">click here</a>.</p>
</body>
</html>
